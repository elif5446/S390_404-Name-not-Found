  ...
  floors: [
    {
      floorId: "MB_S2",
      nodes: [
        // { id: "MB_S2_ENTRANCE_TUNNEL", floorId: "MB_S2", x: 57, y: 491, type: "entrance", label: "Tunnel from Hall Building" },
      ...
      edges: [
        // { nodeAId: "MB_S2_ENTRANCE_TUNNEL", nodeBId: "MB_S2_N17", accessible: true },
        // //hall to hall
