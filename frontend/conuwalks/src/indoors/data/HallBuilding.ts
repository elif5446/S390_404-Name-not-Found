...
export const hallBuildingNavConfig: BuildingNavConfig = {
  ...
  floors: [
    {
      ...
      nodes: [
        ...
        {
          id: "H_8_ESCALATOR_UP_TO_FLOOR_9",
          floorId: "H_8",
          x: 488,
          y: 431,
          type: "escalator",
          label: "Escalator Up to Floor 9",
        },
        {
          id: "H_8_ESCALATOR_DOWN_TO_FLOOR_2",
          floorId: "H_8",
          x: 488,
          y: 617,
          type: "escalator",
          label: "Escalator Down to Floor 2",
        },
      ],
      edges: [
        //hall to hall
        ...
        {
          nodeAId: "H_8_N5",
          nodeBId: "H_8_ESCALATOR_UP_TO_FLOOR_9",
          accessible: false,
        },
        {
          nodeAId: "H_8_N18",
          nodeBId: "H_8_ESCALATOR_DOWN_TO_FLOOR_2",
          accessible: false,
        },
    ...
    },
    {
      ...
      nodes: [
        ...
        {
          id: "H_9_ESCALATOR_DOWN_TO_FLOOR_8",
          floorId: "H_9",
          x: 480,
          y: 444,
          type: "escalator",
          label: "Escalator Down to Floor 8",
        },
        {
          id: "H_9_ESCALATOR_UP_TO_FLOOR_10",
          floorId: "H_9",
          x: 515,
          y: 444,
          type: "escalator",
          label: "Escalator Up to Floor 10",
        },
      ],
      edges: [
        //hall to hall
        ...
        {
          nodeAId: "H_9_ESCALATOR_DOWN_TO_FLOOR_8",
          nodeBId: "H_9_N25",
          accessible: false,
        },
        {
          nodeAId: "H_9_ESCALATOR_UP_TO_FLOOR_10",
          nodeBId: "H_9_N25",
          accessible: false,
        },
      ],
    },
    {
      ...
      nodes: [
        ...
        {
          id: "H_1_ESCALATOR_UP_TO_FLOOR_1",
          floorId: "H_1",
          x: 775,
          y: 725,
          type: "escalator",
          label: "Escalator Up to Floor 1",
        },
        {
          id: "H_1_ESCALATOR_DOWN_TO_FLOOR_1",
          floorId: "H_1",
          x: 640,
          y: 620,
          type: "escalator",
          label: "Escalator Down to Floor 1",
        },
        {
          id: "H_1_ESCALATOR_UP_TO_FLOOR_2",
          floorId: "H_1",
          x: 827,
          y: 618,
          type: "escalator",
          label: "Escalator Up to Floor 2",
        },
      ...
      edges: [
        ...
        {
          nodeAId: "H_1_ESCALATOR_UP_TO_FLOOR_1",
          nodeBId: "H_1_N7",
          accessible: false,
        },
        {
          nodeAId: "H_1_ESCALATOR_DOWN_TO_FLOOR_1",
          nodeBId: "H_1_N8",
          accessible: false,
        },
        {
          nodeAId: "H_1_ESCALATOR_UP_TO_FLOOR_2",
          nodeBId: "H_1_N7",
          accessible: false,
        },
    ...
    },
    {
      ...
      nodes: [
        ...
        //escalator
        {
          id: "H_2_ESCALATOR_DOWN_TO_FLOOR_1",
          floorId: "H_2",
          x: 608,
          y: 811,
          type: "escalator",
        ...
        {
          id: "H_2_ESCALATOR_UP_TO_FLOOR_2",
          floorId: "H_2",
          x: 759,
          y: 811,
          type: "escalator",
          label: "Escalator on Floor 2",
        },
        {
          id: "H_2_ESCALATOR_UP_TO_FLOOR_8",
          floorId: "H_2",
          x: 574,
          y: 429,
          type: "escalator",
          label: "Escalator Up to Floor 8",
        },
        {
          id: "H_2_ESCALATOR_DOWN_TO_FLOOR_2",
          floorId: "H_2",
          x: 519,
          y: 681,
          type: "escalator",
      ...
      edges: [
        ...
        {
          nodeAId: "H_2_N1",
          nodeBId: "H_2_ESCALATOR_DOWN_TO_FLOOR_1",
          accessible: false,
        },
        {
          nodeAId: "H_2_N3",
          nodeBId: "H_2_ESCALATOR_UP_TO_FLOOR_2",
          accessible: false,
        },

        {
          nodeAId: "H_2_N4",
          nodeBId: "H_2_ESCALATOR_UP_TO_FLOOR_8",
          accessible: false,
        },
        {
          nodeAId: "H_2_N6",
        ...
        {
          nodeAId: "H_2_N1",
          nodeBId: "H_2_ESCALATOR_DOWN_TO_FLOOR_2",
          accessible: false,
        },
  ...
  interFloorEdges: [
    ...
    {
      nodeAId: "H_8_ESCALATOR_UP_TO_FLOOR_9",
      nodeBId: "H_9_ESCALATOR_UP_TO_FLOOR_10",
      accessible: false,
    },

    // edges that connect floors for H2 and H8
    {
      nodeAId: "H_2_ESCALATOR_UP_TO_FLOOR_8",
      nodeBId: "H_8_ESCALATOR_UP_TO_FLOOR_9",
      accessible: false,
    },
    {
      nodeAId: "H_8_ESCALATOR_DOWN_TO_FLOOR_2",
      nodeBId: "H_2_ESCALATOR_DOWN_TO_FLOOR_2",
      accessible: false,
    },
    ...
    {
      nodeAId: "H_2_ESCALATOR_DOWN_TO_FLOOR_1",
      nodeBId: "H_1_ESCALATOR_DOWN_TO_FLOOR_1",
      accessible: false,
    },
