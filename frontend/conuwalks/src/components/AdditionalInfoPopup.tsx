...
>(
  (
    ...
    const sheetSolidOpacity = translateY.interpolate({
      // Liquid Glass Effect When Collapsed, Opaque When Pulled Up
      inputRange: [0, 50],
      outputRange: [1, 0],
      extrapolate: "clamp",
    });
                    ...
                    <View style={styles.noEventsContainer}>
                      ...
                      {nextEvent && (
                        <>
                          ...
                          <View style={styles.eventItemWithButton}>
                            ...
                            <TouchableOpacity
                              ...
                              accessibilityRole="button"
                              accessibilityLabel={`Directions to ${nextEvent.courseName}, ${directionsEtaLabel || "--"}`}
                              accessibilityHint="Opens directions panel"
                            >
                              <View style={styles.directionButtonInner}>
                                <MaterialIcons
                                  name="subdirectory-arrow-right"
                                  size={12}
                                  color={campusPink}
                        ...
                        (event: BuildingEvent, index: number) => (
                          ...
                          >
                            ...
                            <TouchableOpacity
                              ...
                              style={styles.directionButton}
                              accessibilityRole="button"
                              accessibilityLabel={`Directions to ${event.courseName}, ${directionsEtaLabel || "--"}`}
                              accessibilityHint="Opens directions panel"
                            >
                              <View style={styles.directionButtonInner}>
                                <MaterialIcons
