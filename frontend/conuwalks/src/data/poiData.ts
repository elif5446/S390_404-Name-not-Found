...
const POI_DATA: Record<string, POI[]> = {
            ...
            "VL-2": [
              ...
              // Stairs
              {
                ...
                room: "S1",
                floor: 2,
                mapPosition: { x: 0.749, y: 0.770 }, // 767/1024, 789/1024
              },
              {
                id: "VL-2-stairs-2",
                label: "Stairs",
              ...
              // Elevator
              {
                ...
                room: "E1",
                floor: 2,
                mapPosition: { x: 0.220, y: 0.517 }, // 225/1024, 530/1024
              },
            ],
          // VL Building – Floor 1
          "VL-1": [
            ...
            // Elevator
            {
              ...
              room: "E1",
              floor: 1,
              mapPosition: { x: 0.220, y: 0.510 }, // 225/1024, 522/1024
            },
          ],
        ...
        "H-2": [
          // Hive Cafe
          {
            ...
            room: "HIVE_CAFE",
            floor: 2,
            mapPosition: mapPositionFromNode("H_2_HIVE_CAFE", { x: 0.460, y: 0.250 }),
            showLabel: true,
          },
          // Student Union
          {
